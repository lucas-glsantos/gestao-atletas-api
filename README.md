...
# 🏋️ **Gestão de Atletas API**

## Desenvolvendo uma API assíncrona com FastAPI

Este projeto é uma API Rest assíncrona de gestão de atletas. É simples, intuitivo e hands-on, Construída com [FastAPI](https://fastapi.tiangolo.com/).
...
![MER](img/mer.jpg "Modelagem de entidade e relacionamento")
...
```bash
git clone https://github.com/lucas-glsantos/gestao-atletas-api.git
cd gestao-atletas-api
```

### 2. Configurar variáveis de ambiente
Modifique o arquivo `.env.exemplo` e `docker-compose.exemplo.yml` na raiz do projeto:
```bash
DATABASE_URL=postgresql+asyncpg://user:password@db:5432/gestaoatletas
```
...
## 👨‍💻 Autor
Projeto desenvolvido by [Lucas Santos](https://linkedin.com/in/lucasglsantos/), para fins educacionais e de portfólio, com foco em boas práticas de Software Engineering, backend moderno em Python e arquitetura escalável.